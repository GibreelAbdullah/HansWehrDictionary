    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _CharityCard(name: 'Sadaqa', url: 'https://sadaqa.org.au/', color: cs.primary),
          const SizedBox(height: 10),
          _CharityCard(name: 'IDRF', url: 'https://idrf.ca/', color: cs.tertiary),
          const SizedBox(height: 10),
          _CharityCard(name: 'Miles2Smile', url: 'https://miles2smile.org/', color: cs.secondary),
